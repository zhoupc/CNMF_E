...
load(fullfile('/net/feevault/data0/shared/EmilyShijieShared/BatchResult/6922FirstFewDaysForBatchNewMerging/','LogisticscnmfeBatchVer.mat')); cnmfeBatchVer_ClusterPart "