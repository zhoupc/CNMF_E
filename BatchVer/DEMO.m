...
[datadir,sampledir,outputdir,filelist,samplelist]=...
           InputOutput('datadir','/Volumes/shared/EmilyShijieShared/BatchResult/6922FirstFewDays2017032930NewMerging/',...
                       'sampledir',[],...
                       'outputdir','/Volumes/shared/EmilyShijieShared/6922/03_29and30/',...
                       'datakind','*',...
                       'samplekind','*Ca*',...
                       'SamplingMethod','auto',...
                       'dataMethod','manual');
