...
[datadir,sampledir,outputdir,filelist,samplelist]=...
           InputOutput('datadir','/Volumes/data0-shared/elm/ProcessedCalciumData/6922FirstFewDaysForBatch/JustSinging/',...
                       'sampledir',[],...
                       'outputdir','/Volumes/shared/EmilyShijieShared/BatchResult/6922FirstFewDays2017032930NewMerging/WeekendMorningResult/',...
                       'datakind','*',...
                       'samplekind','*Ca*',...
                       'SamplingMethod','auto',...
                       'dataMethod','manual');
...
MATLABcommands=['module add mit/matlab/2016b\n',...
    ...
    'load(fullfile(''%s'',''%s'')); cnmfeBatchVer_ClusterPartChuncked"'];
