...
%  The function chooses a minimal spike size for sparse deconvolution
...
%   inspired from choose_lambda.m written by Eftychios A. Pnevmatikakis, 2016, Simons Foundation
...
smin = sn*norminv(prob)/(norm(kernel)^2);