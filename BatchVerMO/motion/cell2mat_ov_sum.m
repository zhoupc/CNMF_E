...
xx_s=xx_s-sz(1)+1; xx_f=xx_f-sz(1)+1;
yy_s=yy_s-sz(3)+1; yy_f=yy_f-sz(3)+1;
zz_s=zz_s-sz(5)+1; zz_f=zz_f-sz(5)+1;
sz=[sz(2)-sz(1)+1 sz(4)-sz(3)+1 sz(6)-sz(5)+1];
X = NaN(sz(1),sz(2),sz(3));
