...
[datadir,sampledir,outputdir,filelist,samplelist]=...
           InputOutput('datadir','/Volumes/shared-1/EmilyShijieShared/ProcessedCalciumData/6922_March31Late/',...
                       'sampledir',[],...
                       'outputdir','/Volumes/shared-1/EmilyShijieShared/ProcessedCalciumData/6922_March31Late/',...
                       'datakind','*Ca*',...
                       'samplekind','*',...
                       'SamplingMethod','auto',...
                       'dataMethod','auto');
%(1.1, replace for actual dir on cluster)
datadir=strrep(datadir,'/Volumes/shared-1/','/net/feevault/data0/shared/');
sampledir=strrep(sampledir,'/Volumes/shared-1/','/net/feevault/data0/shared/');
...
fileID = fopen('BatchVerSLURM6922Sing0331.sh','w');
request={'#!/bin/bash'
    ''
    '#SBATCH -n 1'
